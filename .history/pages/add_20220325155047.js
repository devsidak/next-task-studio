...
function Add() {
  ...
  return (
    <Container>
      <div className={ styles.container +  " flex-col  mt-10 border-2 border-gray-700 rounded-3xl p-5  "}>
        <form className={'w-full flex-col items-center justify-center'} onSubmit={handleSubmit}>
          <input type="text" className={' w-full'} ref={inputRef} placeholder="Add a Task ..." /> <br/>
          <button className={homeStyles.Button + ' self-center mt-5 flex justify-center items-center'} type="submit">
            Add Task
          </button>
        </form>
