    ...
    <div className={styles.secondRowContainer + " "}>
      <div className={"mr-3 p-5 rounded-xl"}>
        <div className={styles.contentBox + ' text-center'}>
            <h1 className={'text-xl md:text-2xl'}>{CalculateCompletedPercentage} Tasks</h1>
      ...
      <div className={styles.contentBox + ' text-center'}>
            <h1 className={'text-xl md:text-2xl'}>{tasks.length - CalculateCompletedPercentage} Tasks</h1>
