...
function Calender() {
  ...
  return (
    <div className={styles.container + ' py-1 px-6'}>
        ...
        <div className={styles.profileContainer + ' py-6 my-8 '}>
            <div >
        ...
        <Calendar className={'border-2 p-6 border-gray-700 rounded-3xl shadow-sm shadow-gray-500 '} onChange={onChange} value={value} />
    </div>
  );
}
